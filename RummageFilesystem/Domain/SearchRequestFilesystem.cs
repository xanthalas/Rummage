...
namespace RummageFilesystem.Domain
{
    ...
    {
        private const string SEARCH_TYPE = "FILESYSTEM";
        ...
        public virtual int SearchRequestId { get; set; }
        ...
        /// <summary>
        /// The name of this search request. 
        /// </summary>
        /// <remarks>This is an optional field which allows the user to save a search request with a name</remarks>
        public virtual string Name { get; set; }

        /// <summary>
        /// Holds details of the containers to search. For the filesystem these containers are directories.
        /// </summary>
        public virtual List<string> SearchContainers { get; set; }

        /// <summary>
        /// Holds the strings to search for.
        /// </summary>
        public virtual List<string> SearchStrings { get; set; }
        ...
        /// </summary>
        public virtual List<string> IncludeContainerStrings { get; set; }
        ...
        /// </summary>
        public virtual List<string> ExcludeContainerStrings { get; set; }
        ...
        /// </summary>
        public virtual bool SearchHidden { get; set; }

        /// <summary>
        /// Indicates whether to search binary items.
        /// </summary>
        public virtual bool SearchBinaries { get; set; }
        ...
        /// </summary>
        public virtual List<string> Urls
        {
            get
            {
                if (_isPrepared)
